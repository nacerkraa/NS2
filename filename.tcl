# Crietion du simulateur
set ns [new Simulator]
# Creation du fichier de traces NS-2
set nf [open out.nam w]
$ns namtrace-all $nf
# Procedure de fin de simulation, qui ecrit les donnees dans le fichier
...
set n2 [$ns node]
set n3 [$ns node]
# Creation des liens, tous en 1Mbps/10ms de TR/file d'attente DropTail
$ns duplex-link $n0 $n2 1Mb 10ms DropTail
$ns duplex-link $n1 $n2 1Mb 10ms DropTail
$ns duplex-link $n3 $n2 1Mb 10ms DropTail
# Creation de deux agents implants dans n0 et n1
